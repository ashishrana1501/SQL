...
FROM
    employees
WHERE
    first_name LIKE 'D%' AND gender = 'M';       
...
FROM
    employees
WHERE
    first_name LIKE '%a%' AND gender = 'F';
...
FROM
    employees
WHERE
    first_name IN ('Denis' , 'Cathie', 'Mark', 'Nathan');
...
FROM
    employees
WHERE
    first_name NOT IN ('Denis' , 'Cathie', 'Mark', 'Nathan'); 
...
SELECT 
    birth_date, MIN(birth_date), MAX(birth_date)
FROM
    employees;
...
FROM
    employees
WHERE
    birth_date BETWEEN '1955-01-01' AND '1960-01-01';
...
FROM
    employees
WHERE
    birth_date NOT BETWEEN '1955-01-01' AND '1960-01-01';
...
SELECT 
    first_name, COUNT(first_name) AS Namecount
FROM
    employees
GROUP BY first_name
ORDER BY first_name DESC;
...
# Interview question
# when to use WHERE AND WHEN TO USE HAVING CLAUSE
...
SELECT 
    first_name,
    COUNT(first_name) AS Count_of_first_name,
    last_name,
...
INSERT INTO employees VALUES(10000, "1952-08-01", "Ashish", "Rana", "M", "1985-02-22");
...
SET 
    dept_no = '501',
    dept_name = 'statistics department';
...
SELECT 
    ROUND(AVG(salary)) AS Avearge_Salary
FROM
    salaries;
    
SELECT 
    ROUND(AVG(salary), 2) AS Avearge_Salary
FROM
    salaries;
